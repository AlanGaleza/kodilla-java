...
@SpringBootTest
public class TaskFinancialDaoTestSuite {
    ...
    public void testFindByPaid() {
        ...
        //When
        List<TaskFinancialDetails> resultLits = taskFinancialDetailsDao.findByPaid(false);

        //Then
        Assert.assertEquals(1, resultLits.size());
