...
public class SpringRunnerTestsSuite {
	...
	public void testCircleLoadedIntoContainer() {
		...
		//Shape shape = context.getBean(Circle.class); // mozna tak albo...
	...
	public void testTriangleLoadedIntoContainer() {
		//Given
		ApplicationContext context = new AnnotationConfigApplicationContext("com.kodilla.spring");
		//Shape shape = context.getBean(Triangle.class); //mozna tak albo...
	...
	public void testSquareLoadedIntoContainer(){
		//Given
		ApplicationContext context = new AnnotationConfigApplicationContext("com.kodilla.spring");
		//Shape shape = context.getBean(Square.class); //mozna tak albo...
